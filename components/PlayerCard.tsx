...
export default function PlayerCard({
  ...
  return (
    <Link
      ...
      className="bg-white rounded-xl shadow p-4 flex flex-col items-center text-center hover:shadow-lg hover:-translate-y-0.5 transition border-4 border-red-800"
    >
      {/* Player photo with overlayed upload button */}
      <div className="relative w-24 h-24 rounded-full overflow-hidden border-2 border-red-800 bg-white flex items-center justify-center">
        <PhotoUploader
      ...
      <div className="mt-3">
        ...
        <div className="text-[11px] inline-block bg-red-800 text-white rounded-full px-2 py-1 font-semibold uppercase tracking-wide mt-1">
          {player.position}
        </div>
      </div>
      ...
      <div className="mt-3 flex flex-col items-center gap-1">
        <div className="text-xs font-semibold text-red-800 bg-red-50 border border-red-200 rounded-full px-2 py-1">
          {levelInfo.name}
        </div>
      ...
      <div className="mt-4 flex gap-4 text-sm font-semibold">
        <div className="flex flex-col">
          <span className="text-red-800 text-base uppercase tracking-wide">
            G
          </span>
          <span>{goals}</span>
        </div>
